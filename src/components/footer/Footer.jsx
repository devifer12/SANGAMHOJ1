...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="bg-burgundy pt-16 pb-10 border-t border-gold/20"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4 text-gold">
              <a
                href="https://shorturl.at/o1e1s"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-gold/80"
              >
