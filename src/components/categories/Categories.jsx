        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {categories.map((category) => (
            <div key={category.title} className="group cursor-pointer relative overflow-hidden rounded-lg">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-burgundy bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
